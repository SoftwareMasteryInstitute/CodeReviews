...
The library simulate a Pacman moving within a square grid without any obstructions. To start the simulater, Pacman has to be placed on the grid.
...
contains all the interfaces, exceptions and the directions of the Pacman. PacmanProject contains functionalities of the pacman and grid. 
Simulater inside the Pacman_Simulator is used to pass the given command to the Pacman. When you run the console application, commands will be exected 
automatically and output will be displayed on the console window.
