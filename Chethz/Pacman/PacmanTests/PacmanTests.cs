...
namespace PacmanTests
{
    public class PacmanTests
    {
        ...
        [Test]
        public void Place_WhenPlaceOutsideGrid_ShouldStayInSamePosition()
        {
            var ex = Assert.Throws<InvalidCoordinatesException>(() => _pacman.Place(_grid, 6,6, Directions.Face.NORTH));
            Assert.AreEqual("Entered coordinates are out side the grid", ex.Message);
        }

        [Test]
        public void Place_WhenPlaceAgainInDifferentCoordinates_ShouldPlaceInNewCoordinates()
        {
        ...
        [Test]
        public void Left_WhenTurn_ShouldTurnNinteeDegreesLeft()
        {
            _pacman.Place(_grid, _pacman.X, _pacman.Y, _pacman.Face);
            _pacman.Left();
        ...
        [Test]
        public void Right_WhenTurn_ShouldTurnNinteeDegreesRight()
        {
            _pacman.Place(_grid, _pacman.X, _pacman.Y, _pacman.Face);
            _pacman.Right();
